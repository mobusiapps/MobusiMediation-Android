...
```java
dependencies {
   compile(name: 'mobusimediation-base-1.14.1', ext:'aar')
    compile(name: 'MobusiSDK-3.0.0', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1001-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1002-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1003-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1004-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1005-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1007-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1008-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1009-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1012-1.14.1', ext: 'aar')
    compile(name: 'mobusimediation-mediation-1013-1.14.1', ext: 'aar')
